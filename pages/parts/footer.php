<!--// FOOTER START //-->
            <footer id="footer">
                <div class="widget kode_widget3">
                    <div class="container">
                        <div class="col-md-3 col-sm-6">
                            <div class="kode_widget3_des">
                                <a href="index.html#"><img src="images/logo9.png" style="max-width: 85%; margin-top: 17px" alt=""></a>
                                <p>Изделия из натурального дерева под заказ, по индивидуальным размерам. Высокое качество, кратчайшие сроки</p>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="kode_widget3_content">
                                <h4>Часы работы</h4>
                                <div class="kode_widget_contact twitter">
                                    <ul>
                                        <li>
                ...
                <div class="kode_copyright_widget">
                    <div class="container">
                        <div class="kode_copyright_text">
                            <p></p>
                        </div>
...
<!--js/jquery.js start-->
<!-- Подключаем библиотеку 3.1.1 исключительно для маски -->

<!-- Маска для телефона -->
<script src="/js/jquery.inputmask.js"></script>
<script>
    $(document).ready(function () {
        $("#mask_phone").inputmask("+3(999)9999999");
    });
</script>
