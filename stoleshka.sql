...
--
-- Хост: localhost
-- Время создания: Авг 04 2017 г., 15:49
...
(10, 'Клеенный массив', '', '', '', 'Неопознанный вид покрытия', '2017-08-04', '1', '20', 'Влагостойкий', 'Столешница', '1111', '2222', '', 'Неопознанный тон', 'Ясень'),
(11, 'Неопознанный вид массива', '', '', '', 'Неопознанный вид покрытия', '2017-08-04', '', '', 'Влагостойкий', 'Столешница', '', '', '', 'Неопознанный тон', 'Неопознанное дерево');
